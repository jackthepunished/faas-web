...
/**
 * A soft brand-tinted glow rendered as a dithered dot field: a blurred color
  ...
  return (
    <div aria-hidden className={`pointer-events-none absolute ${className}`}>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(45% 60% at 32% 45%, color-mix(in oklab, var(--brand) 14%, transparent), transparent 70%),' +
            'radial-gradient(40% 55% at 70% 55%, color-mix(in oklab, var(--brand-hover) 9%, transparent), transparent 70%)',
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(color-mix(in oklab, var(--brand) 65%, transparent) 1px, transparent 1.2px)',
