      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-24 sm:px-6 lg:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            Platform teams define custom components once — golden paths with your policies baked in.
            Every developer gets one-click deploys that enforce those rules automatically, right
            next to the infrastructure you already run.
          </p>
        ...
        <Reveal delay={0.15}>
          <div inert aria-hidden="true" className="rounded-xl border border-border bg-card p-6">
