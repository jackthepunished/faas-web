...
/**
 * Paths `apid` owns outright. `/auth/*` is in here because the OAuth consent
 * and callback routes are real full-page navigations to the server.
 */
const API_PATHS = ['/v1', '/auth'];
