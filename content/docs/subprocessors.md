...
| transactional-email | Postmark | Postmark transactional email transport | [recipient email (account holder only), subject + body of the transactional message] | US (Postmark default) | Postmark Data Processing Addendum (linked from Postmark Dashboard) | `FAAS_MAIL_TRANSPORT` |
| transactional-email | Resend | Resend transactional email transport | [recipient email (account holder only), subject + body of the transactional message] | US (Resend default) | Resend Data Processing Addendum (linked from Resend Dashboard) | `FAAS_MAIL_TRANSPORT` |
